...
class Controller(object):
    def __init__(self, script_path, arguments, output):
        ...
        if arguments.logs_location and self.validate_path(arguments.logs_location):
            ...
            self.logs_path = FileUtils.build_path(os.path.dirname(os.path.dirname(self.script_path)), "reports", "dir_scan_report")
        ...
        if arguments.output_location and self.validate_path(arguments.output_location):
            ...
            self.report_path = FileUtils.build_path(os.path.dirname(os.path.dirname(self.script_path)), "reports", "dir_scan_report")
        ...
        if arguments.use_random_agents:
            self.random_agents = FileUtils.get_lines(
                FileUtils.build_path(os.path.dirname(os.path.dirname(script_path)), "dictionary", "user-agents.dict")
            )
